import 'package:barberias/barberia/ui/widgets/reservation_barber.dart';
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          description,
          Container(
            child: ButtonAddPhotoScreen(buttonText: "Reservar", height: 40.0, width: screenWidth,
              onPressed: (){
                Navigator.push(
                    context,
                    MaterialPageRoute(builder:
                        (BuildContext context) => ReservationBarber()));
              },),
          )
        ],
      ),
