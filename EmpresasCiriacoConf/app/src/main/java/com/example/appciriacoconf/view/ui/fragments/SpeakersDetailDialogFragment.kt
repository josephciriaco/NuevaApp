...
class SpeakersDetailDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbarSpeakerConference.navigationIcon = ContextCompat.getDrawable(view.context, R.drawable.ic_close)
        toolbarSpeakerConference.setNavigationOnClickListener {
            dismiss()
        }

        val speaker = arguments?.getSerializable("speaker") as Speaker
        toolbarSpeakerConference.title = speaker.name
        toolbarSpeakerConference.setTitleTextColor(Color.WHITE)
