...
import com.example.appciriacoconf.model.Ubication
...
class UbicationFragment : Fragment(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        markerOptions.title("Ciriaco Conf 2022")

        val bitmapDraw = context?.applicationContext?.let { ContextCompat.getDrawable(it, R.drawable.logo_map) } as BitmapDrawable
        val smallMarker = Bitmap.createScaledBitmap(bitmapDraw.bitmap, 70, 70, false)
